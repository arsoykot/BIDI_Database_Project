...
def home():
    ...
    content=f"<div class='top'><h1>Executive Dashboard</h1><span class='badge'>Live DB</span></div><div class='stats'><div class='stat'><div class='muted'>Projects</div><div class='num'>{p[0][0]}</div></div><div class='stat'><div class='muted'>Employees</div><div class='num'>{e[0][0]}</div></div><div class='stat'><div class='muted'>Customers</div><div class='num'>{c[0][0]}</div></div><div class='stat'><div class='muted'>Audit Rows</div><div class='num'>{a[0][0]}</div></div></div><div class='card'>Premium frontend connected to your PostgreSQL project.</div>"
